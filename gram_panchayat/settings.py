...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,gram-panchayat-fubgao.onrender.com', cast=Csv())
...
# Parse DATABASE_URL if available (for cloud deployment)
